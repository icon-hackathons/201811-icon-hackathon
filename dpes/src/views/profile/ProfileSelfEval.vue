  ...
  <div class="text-left">
        ...
        <div class="card" style="">
          <div class="row">
            ...
            <div class="col-lg-10">
              ...
              <Star :readonly="true" :name="'1_5'" :value="profile['selfReview']['1_5']"></Star>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row mt-5">
      ...
      <div class="profile-card card-columns" style="column-count: 2;">
        ...
        <div class="card" style="">
          <Star :readonly="true" :name="'4_1'" :value="profile['selfReview']['4_1']"></Star>
        </div>
      </div>
    </div>
  </div>
