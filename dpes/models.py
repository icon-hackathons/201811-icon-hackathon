...
# - from: 평가를 주는 사람
# - to: 평가를 받은 사람
# - eveluation1: 평가 대상자와 밀접하게 일한 1-2개의 프로젝트는 무엇이었습니까?
# - eveluation2: 질과 양 모든 측면에서 평가 대상자는 프로젝트에 어떻게 기여하였습니까? (5단계 Rating으로 평가)
# - eveluation3: 대상자가 팀의 성공에 얼마큼 기여하였습니까? (5단계 Rating으로 평가)
# - eveluation4: 우리 회사의 핵심 가치관 중에 가장 잘 실천한 것은 무엇입니까?
# - eveluation5: 우리 회사의 핵심 가치관 중 더 잘 실천해야 할 것은 무엇입니까?
# - eveluation6: 평가 대상자는 어떠한 강점을 가지고 있습니까?
# - eveluation7: 다음 6개월 동안에 평가 대상자가 더 큰 기여를 하기 위해 성장할 영역을 한 가지만 고르면 어떤 것인가요?
