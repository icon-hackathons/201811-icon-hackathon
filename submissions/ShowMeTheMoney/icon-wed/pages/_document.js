            ...
            <html>
                <Head>
                    ...
                    <style jsx global>{`
                        ...
                        .main.eat > div.title { text-align: center; height: 80px; line-height: 80px; font-size: 20px; }
                        .main.eat > p { position: relative; top: 50px; display: inline-block; width: 65vw; font-size: 15px; }
                        .main.eat > img { position: absolute; top: 265px; left: calc(35vw / 2); display: inline-block; width: 65vw; }
                        .main.eat > div.count { font-size: 20px; font-weight: bold; position: absolute; top: 377px; left: calc(35vw / 2); display: inline-block; width: 65vw; }
                        ...
                        .check > .content > .list > table.selector { margin-bottom: 10px; }
                        .check input.pw { display: inline-block; width: calc(100vw - 150px); }
                        .check button.pw { display: inline-block; width: 80px !important; margin-left: 10px; }

                        .register > .content.congratulate tr > td:first-child { width: 90px; }
                        .register > .content.congratulate tr > td > input { width: calc(100vw - 155px); }
                        .register > .content.congratulate > table > tbody td > button { display: inline-block; text-align: center; }
                        .register > .content.congratulate > table > tbody td > span { float: right; display: inline-block; width: 120px; color: #0aafb3; text-decoration: underline; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 15px; padding-top: 5px; }
                        .register > .content.congratulate .address { width: 110px; }
                        .register > .content.congratulate div.attend { display: inline-block; float: left; padding-top: 6px; }
                        .register > .content.congratulate table.attend { width: 190px !important; padding: 0 30px !important; display: inline-block; table-layout: fixed; padding: 0 20px; width: 100vw; text-align: left;  }
                        .register > .content.congratulate table.last { margin-bottom: 40px; }
                        .register > .content.congratulate table .height { height: 50px; }

                        // 공통
                        table.selector { table-layout: fixed; padding: 0 20px; width: 100vw; text-align: left; padding-top: 7px;  }
                        table.selector tr { text-align: left; font-size: 18px; }
                        table.selector tr:first-child { margin-bottom: 10px; }
                        table.selector tr > td { padding: 5px; }
                        table.selector tr > td > span { width: 5px; height: 5px; display: inline-block; border-radius: 15px; border: 4px solid #0aafb3; }
                        table.selector tr > td > span.on { background-color: white;}                
                        table.selector tr > td > span.off { background-color: #0aafb3; opacity: 0.5; }
